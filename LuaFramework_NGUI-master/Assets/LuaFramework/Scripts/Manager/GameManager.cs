    ...
    public class GameManager : Manager {
        ...
        IEnumerator OnExtractResource() {
            ...
            foreach (var file in files) {
                index++;
                facade.SendMessageCommand(NotiConst.UPDATE_SLIDER, (index / files.Length).ToString());
        ...
        IEnumerator OnUpdateResource() {
            ...
            for (int i = 0; i < files.Length; i++) {
                message = (((float)(i + 1)) /files.Length ).ToString();
                facade.SendMessageCommand(NotiConst.UPDATE_SLIDER, message);
...
//            LuaManager.DoFile("Logic/GameNetwork");         //加载网络
///*            GameNetManager.OnInit();       */                 //初始化网络
...
//            Util.CallMethod("Game", "OnInitOK");          //初始化完成
        ...
        private void GetMac()
        {
            ...
            //获取本机的mac值无法在lua中获取,只能在c#中获取,如果有多个,只取第一个
            //AppConst.Mac = PlayerPrefs.GetString("mac", "");
            print(AppConst.Mac);
            //if (AppConst.Mac != "") return; 
            ...
            //if (AppConst.Mac == "")
            //{
            //    GameObject.Find("LoadingUI/Camera/Loading/GameObject").GetComponent<UILabel>().text = "Mac为空";
            //}
            //else
            //{
            //    GameObject.Find("LoadingUI/Camera/Loading/GameObject").GetComponent<UILabel>().text = AppConst.Mac;
            //}
            ...
            AppConst.Mac = macAddress;
            GameObject.Find("LoadingUI/Camera/Loading/GameObject").GetComponent<UILabel>().text =macAddress;
        }
        /// <summary>
        /// 析构函数
        /// </summary>
