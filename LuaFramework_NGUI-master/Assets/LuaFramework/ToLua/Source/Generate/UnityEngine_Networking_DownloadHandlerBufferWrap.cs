...
public class UnityEngine_Networking_DownloadHandlerBufferWrap
{
	...
	static int GetContent(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Networking.UnityWebRequest arg0 = (UnityEngine.Networking.UnityWebRequest)ToLua.CheckObject(L, 1, typeof(UnityEngine.Networking.UnityWebRequest));
