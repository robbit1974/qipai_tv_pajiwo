...
namespace LuaFramework {
    ...
    public class ObjectPoolManager : Manager {
        ...
        public GameObjectPool CreatePool(string poolName, int initSize, int maxSize, GameObject prefab) {
            ...
            {
                return m_GameObjectPools[poolName].NewGameObjectPool(poolName, prefab,initSize, maxSize, PoolRootObject);
            }
        ...
        public int GetPoolObjNum(string poolName)
        {
            if (m_GameObjectPools.ContainsKey(poolName))
            {
                return m_GameObjectPools[poolName].PoolSize;
            }
            return 0;
        }
