...
public class LuaFramework_LuaHelperWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetDaTingWebSocketManager", GetDaTingWebSocketManager);
		L.RegFunction("GetGameWebSocketManager", GetGameWebSocketManager);
		L.RegFunction("GetSetWechatHeadManager", GetSetWechatHeadManager);
		L.RegFunction("GetObjectPooltManager", GetObjectPooltManager);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetSetWechatHeadManager(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			SetWechatHead o = LuaFramework.LuaHelper.GetSetWechatHeadManager();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
